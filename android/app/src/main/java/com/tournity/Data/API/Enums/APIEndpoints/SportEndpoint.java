...
public enum SportEndpoint implements Endpoint {
    getByIdSport("sport/", Request.Method.GET, APIResponseDataType.ARRAY);

    private String endPoint;
    private int method;
    private APIResponseDataType dataType;

    SportEndpoint(String endPoint, int method, APIResponseDataType dataType) {
